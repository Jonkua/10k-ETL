...
from utils.get_10k_filing import get_ticker_10k_filing
from utils.file_operations.collect_ticker_files import collect_ticker_files
from utils.file_operations.delete_txt_file import delete_txt_file
from utils.processing.process_html import process_html
...
def process_ticker_10k_data(ticker, cik, title):
    ...
    delete_txt_file(ticker_files_dict.get(ticker, []))
    ...
    with concurrent.futures.ThreadPoolExecutor() as executor:
        ...
        results = executor.map(
            lambda file: process_html(file, ticker, cik, title), html_files
        )
